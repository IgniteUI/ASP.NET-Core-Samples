...
export class TaskPlannerComponent implements OnInit, AfterViewInit {
    ...
    public columns: any[] = [
        ...
        { field: 'title', header: 'title', width: '120px', dataType: 'number', formatter: this.formatID, sortable: true },
        ...
        { field: 'asignee', header: 'Owner', width: '180px', dataType: 'string', resizable: true, editable: true, sortable: false, filterable: false },
